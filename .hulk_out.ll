...
@1 = private constant [3 x i8] c"ok\00"
@2 = private constant [5 x i8] c"fail\00"
...
entry:
  ...
  %14 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (%BoxedValue, ptr null, i32 1) to i64))
  %15 = getelementptr inbounds nuw %BoxedValue, ptr %14, i32 0, i32 0
  store i32 1, ptr %15, align 4
  %16 = getelementptr inbounds nuw %BoxedValue, ptr %14, i32 0, i32 1
  store double %add, ptr %16, align 8
  ret ptr %14
}
...
entry:
  ...
  store double %add, ptr %18, align 8
  ret ptr %16
}
...
entry:
  ...
  store i32 1, ptr %17, align 4
  %18 = getelementptr inbounds nuw %BoxedValue, ptr %16, i32 0, i32 1
  store double %mul1, ptr %18, align 8
  ret ptr %16
}
